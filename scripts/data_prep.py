...
with open(_, 'rb') as file:
    df = pickle.load(file)
df=df[df['Year'].isin(['2017', '2016', '2015', '2016', '2015', '2014', '2013', '2012', '2011', '2010'])]
...
population_df.drop(['Census', 'Estimates Base', 2019, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2018], axis=1, inplace=True)
...
df.rename(columns={0: "Population_2017"}, inplace=True)
